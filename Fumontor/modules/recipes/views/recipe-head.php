              ...
              <div class="menu-container" id="showme" ng-class="{showme:open}">
                  <nav class="menu menu--prospero" id="navbar">
                      <ul class="menu__list">
                          ...
                          <li class="menu__item menu__item--current"  ng-click="setCurrent(4)" ng-class="{'menu__item--current':menuList[4].current}" ><a href="recipes/#/"  class="menu__link" ><span class="home-icons recipe-icon"></span><span class="home-icons large">Recipe</span></a></li>
