<div class="login-container cool-border">
              ...
              <div class="space text-center text-red"></div>
                <p class=" register-link">
                         

                      
                      <a href="social/session/facebook?from=recipes" id="" class="cool-shadow  loginBtn--facebook loginBtn host-btn ">Signin with facebook</a>
                     
                </p>
                <label class="or"></label>
              <div id="infoMessage" class="login-info"></div>

              <?php echo form_open("auth/login/recipes",array("class"=>"loginForm"));?>
