    ...
    <div class="col-md-3">
        ...
        <div class="product-or-kitchen all-page" ng-if="location!=undefined">
            <div class="pro-or-kit-container">
                ...
                <a href="#/search/{{location}}/{{orderType}}" class="btn btn-default btn-emboshed ">Products</a>
                <a href="#/all-kitchen/{{location}}" class="btn btn-emboshed btn-danger not-active">Kithcens</a>
                <a href="#/all-kitchen" class="btn btn-default btn-emboshed ">All kithcen</a>
            </div>
        </div>
        ...
        <div class="horizontal-card kitchen-card cool-shadow bg-white fadeIn animated space" ng-repeat="kitchen in allKitchens|filter:search" >
