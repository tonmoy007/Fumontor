...
{
	protected $scope = array('offline_access', 'email', 'read_stream','public_profile');
	...
	{
		$url = 'https://graph.facebook.com/me?fields=name,email,first_name,last_name&'.http_build_query(array(
