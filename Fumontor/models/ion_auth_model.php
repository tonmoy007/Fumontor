...
class Ion_auth_model extends CI_Model
{
	...
	public function register($username, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		$phone=($additional_data['phone'])?$additional_data['phone']:'';
		...
		elseif (($this->identity_column == 'phone' || $this->identity_column_alt == 'phone') && $this->phone_check($phone))
		{
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$this->db->select($this->identity_column . ',phone, username, email, id, password, active, last_login')
		                  ->where($this->identity_column, $identity)
		                  ->limit(1)
		    			  ->order_by('id', 'desc');
